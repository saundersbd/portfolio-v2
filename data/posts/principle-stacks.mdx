...
<PageNote
  description={`In episode 177 of the Exponent podcast, Ben Thompson and James Allworth touched on the idea of a "principle stack". Here I expand on that concept and the value it can provide.`}
/>
