...
description: "As a product designer you should not seek the perfect solution to a problem, but one that is good enough. Perfection isn't really possible, so don't waste any time pursuing it. But since you shouldn't aim for perfection, how do you know when it's time to stop? How do you recognize good enough when you see it?"
