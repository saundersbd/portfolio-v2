      ...
      <Grid className="grid-cols-6 gap-y-12">
        ...
        <div className="col-span-full lg:col-start-2 lg:col-end-6 prose prose-lg md:prose-xl dark:prose-dark">
          ...
          <p>
            ...
            . Community helps teams collaborate and stay aligned at work. Other
            product areas I've worked in at Paylocity include payroll, HR, and
            analytics.
          </p>
          ...
          <p>
            ...
            supposed to use Dreamweaver to build them. I knew that wasn't how
            real websites were made, so I spent an afternoon at the library
            ...
            learning more PHP, and eventually I slowly began to teach myself
            Javascript too. I've continued to expand my front end skills and I
            depend on them to communicate with engineers and prototype ideas
            every day. I built this website myself using React and{" "}
          ...
          <p>
            ...
            skills that would become outdated the second I left school. NIU
            taught me what good looks like, and how to think like a designer in
            any medium. Early in the program I only wanted to learn more tools,
            but I've come to realize that they got it right by leading with
            design fundamentals.
          </p>
          ...
          <p>
            ...
            to manage that. The whole site is{" "}
            <a
              target="_blank"
