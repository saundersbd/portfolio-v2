...
const PostAlt = ({ slug, title, description, published }: Post) => {
  ...
  return (
    <div className="mb-2 sm:mb-4">
      <Link
        href={`/blog/${slug}`}
        className="flex items-start p-2 -m-2 transition-all rounded-lg post-link hover:bg-gray-50 dark:hover:bg-gray-700 sm:-m-4 sm:p-4 focus:bg-gray-50 dark:focus:bg-gray-800"
        passHref
      >
        <div className="badge hidden w-[54px] h-[54px] mr-4 sm:flex flex-col flex-shrink-0 items-center justify-center bg-transparent border border-gray-200 dark:border-gray-600 rounded-xl">
