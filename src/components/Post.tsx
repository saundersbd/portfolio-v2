...
const PostAlt = ({ slug, title, description, published }: Post) => {
  ...
  return (
    <div className="mb-2 sm:mb-4">
      <Link
        href={`/blog/${slug}`}
        className="flex items-start p-2 -m-2 transition-all rounded-lg post-link hover:bg-gray-50 dark:hover:bg-gray-800 sm:-m-4 sm:p-4 focus:bg-gray-50 dark:focus:bg-gray-800 group"
        passHref
      >
        <div className="w-[54px] h-[54px] mr-4 sm:flex flex-col flex-shrink-0 items-center justify-center border border-gray-200 dark:border-gray-700 rounded-xl font-sans bg-white dark:bg-gray-900 transition-all">
