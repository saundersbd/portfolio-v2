...
description:
  ...
  This book helped clear up some misconceptions I had about JTBD, and gave me
  plenty of ideas for how to position features and interview customers."
...
Traditional sales are not in sync with the way people buy, and we need to flip
the focus from the supply side to the demand side:
...
> the space for the answer to fit.
...
Moesta, B., Engle, G. (2020). Demand-Side Sales 101: Stop Selling and Help Your
Customers Make Progress. United States: LIONCREST PUB.
