...
const NavLink = React.forwardRef(
  ({ isActive, href, className, children }, ref) => (
    <a
      className={
        `flex items-center justify-center flex-grow sm:flex-grow-0 text-sm sm:text-lg font-normal tracking-wide text-center focus:outline-none focus:ring focus:ring-orange px-5 py-4 hover:bg-orange-lightest dark:hover:bg-gray-900 dark:text-white ` +
        `${className}`
      }
    ...
    <>
      <Link href="/" passHref>
        <NavLink
          ...
          className="py-2 border-t sm:border-t-0 border-orange-light dark:border-orange-lighter"
        >
          Home
        </NavLink>
      </Link>
      ...
      <header className="flex bg-white border-t-0 border-b sm:border-t sm:p-0 sm:items-stretch border-orange-light dark:bg-navy-darkest dark:border-orange-lighter">
        <nav className="relative flex items-center justify-between w-full">
          ...
          <button
            ...
            type="button"
            className="flex items-center justify-center my-4 mr-4 transition-all bg-white border rounded-lg sm:mr-6 border-orange-light sm:my-0 w-9 h-9 dark:bg-navy-dark hover:ring-2 ring-gray-300 dark:ring-orange-lighter dark:border-orange-lighter"
            onClick={() =>
