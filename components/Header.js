        ...
        <ContainerFull>
          <nav className="relative flex items-center justify-between w-full">
            ...
            <button
              ...
              type="button"
              className="flex items-center justify-center w-10 h-10 my-4 transition-all border rounded-lg bg-navy-lightest border-navy-lighter sm:my-0 dark:bg-navy-dark hover:ring-2 ring-gray-300 dark:ring-orange-lighter dark:border-orange-lighter"
              onClick={() =>
            ...
            >
              {mounted && (
                <svg
                  ...
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  className="w-5 h-5 text-navy-light dark:text-gray-200"
                >
                  {resolvedTheme === "dark" ? (
                    <path
                      fillRule="evenodd"
