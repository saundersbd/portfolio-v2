...
const Project = ({ slug, title, description, cover, author }) => (
  <Link
    ...
    passHref
  >
    <a className="flex flex-col mb-6 overflow-hidden transition bg-white border border-gray-300 rounded-md shadow book col-span-full xs:flex-row lg:col-span-1 hover:shadow-lg focus:outline-none focus:ring focus:ring-blue-400 last:mb-0 dark:bg-gray-900 dark:hover:bg-gray-800 dark:border-gray-700 dark:hover:border-gray-600">
