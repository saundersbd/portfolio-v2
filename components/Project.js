...
const Project = ({ slug, title, description, published, projectType }) => {
  ...
  return (
    <div className="mb-2 sm:mb-4 last-of-type:mb-0">
      <Link href={`/projects/${slug.replace(/\.mdx?$/, "")}`} passHref>
        <a className="flex items-start p-2 -m-2 transition-all rounded-lg project-link hover:bg-gray-100 dark:hover:bg-gray-800 sm:-m-4 sm:p-4 focus:bg-gray-50 dark:focus:bg-gray-800">
          <Badge
            icon={projectType}
