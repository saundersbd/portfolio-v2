...
const Button = ({
  ...
  const btnClass = cn({
    ...
    "text-gray-800 bg-beige-dark hover:bg-beige-darker dark:border hover:border-teal dark:border-navy-light dark:bg-navy-dark dark:text-white  dark:hover:bg-navy dark:hover:text-white":
      primary,
