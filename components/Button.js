...
const Button = ({
  ...
  const btnClass = cn({
    "flex items-center justify-center text-base font-medium tracking-wide rounded-md no-underline hover:no-underline focus:outline-none focus:ring focus:ring-orange py-2 px-3 transition": true,
