...
const LibraryRow = ({ author, title, date, url, notes, recommended }) => (
  <li className="grid items-center grid-cols-1 gap-2 py-3 border-b border-gray-300 sm:py-2 dark:border-navy-light sm:grid-cols-12">
    <div className="flex flex-col justify-center col-span-full sm:col-span-10">
      ...
      <div className="flex items-center text-gray-500 dark:text-navy-lighter">
        {author} ({date})
      </div>
    </div>
