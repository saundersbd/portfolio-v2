  ...
  <li className="flex flex-col items-start pb-4 mb-4 border-b border-gray-200 sm:flex-row sm:items-center dark:border-gray-700 last:border-none last:mb-0">
    <div className="flex-grow mb-3 sm:mb-0">
      <div className="flex items-center mb-1">
        {url ? (
          <a
            className="sm:w-max text-sm font-bold text-black dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800 rounded -mx-1 -my-0.5 px-1 py-0.5 mb-0 underline focus:outline-none focus:ring focus:ring-orange transition-all focus:bg-blue-50"
            href={url}
            target="_blank"
          >
            {title}
