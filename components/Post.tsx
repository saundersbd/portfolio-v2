  ...
  return (
    <div className="mb-2 sm:mb-4">
      <Link
        ...
        className="flex items-start p-2 -m-2 transition-all rounded-lg post-link hover:bg-gray-100 dark:hover:bg-gray-800 sm:-m-4 sm:p-4 focus:bg-gray-50 dark:focus:bg-gray-800"
        passHref
      >
